...
> 账本审阅日：`2026-08-28`；源摘要：`sha256:3f72745d9017e3bb5658f4864a35421c706395b505dfbde3d089c6d1c5055fd9`。
...
- 尚无 current review、但已进入唯一 triage group：`188`。
- 新写入流程中尚未关闭的 active dossier：`72`；其中已有 current review `4`；open workflow 不进入历史 triage。
- inventory coverage：`301/301`。
- semantic review coverage：`42/301`。这个比例不会被 triage 人为抬高。
...
| `DOSSIER-OUTER-LOOP-PRECEDENTS-20260824-1C4F82D991` | `.artifacts/outer_loop_precedents_20260824` | `2026-08-24` | `active` |
...
| [`TRIAGE-LOCAL-OPTIONAL-MISC`](#triage-local-optional-misc) | `local_optional_queue` | `low` | 47 | [`CLAIM-LEVER-VERDICTS-ARE-ITEM-AND-REVISION-BOUNDED`](<CATALOG.md#claim-lever-verdicts-are-item-and-revision-bounded>) |
...
| [`TRIAGE-LOCAL-WITNESS`](#triage-local-witness) | `local_optional_queue` | `normal` | 6 | [`CLAIM-CERTIFIED-EXISTENCE-OPEN-20260823`](<CATALOG.md#claim-certified-existence-open-20260823>)<br>[`CLAIM-W0-POWER-OBSTRUCTION-REQUIRES-DECLARED-HEIGHT-PURITY`](<CATALOG.md#claim-w0-power-obstruction-requires-declared-height-purity>)<br>[`REVIEW-20260823-WITNESS-CONSTRUCTOR-OWNER-UNLOCK`](<CATALOG.md#review-20260823-witness-constructor-owner-unlock>)<br>[`REVIEW-20260811-W0-POWER-COUNTEREXAMPLE-BATCH4`](<CATALOG.md#review-20260811-w0-power-counterexample-batch4>) |
...
| [`TRIAGE-WITNESS-TRACKED-LONGTAIL`](#triage-witness-tracked-longtail) | `historical_semantic_queue` | `normal` | 3 | [`CLAIM-CERTIFIED-EXISTENCE-OPEN-20260823`](<CATALOG.md#claim-certified-existence-open-20260823>)<br>[`CLAIM-WITNESS-RESTRICTED-POLE-DOMAINS-INFEASIBLE-FULL-DOMAIN-OPEN`](<CATALOG.md#claim-witness-restricted-pole-domains-infeasible-full-domain-open>)<br>[`REVIEW-20260823-WITNESS-CONSTRUCTOR-OWNER-UNLOCK`](<CATALOG.md#review-20260823-witness-constructor-owner-unlock>)<br>[`REVIEW-20260811-W0-POWER-COUNTEREXAMPLE-BATCH4`](<CATALOG.md#review-20260811-w0-power-counterexample-batch4>) |
...
- **Dossier：** `DOSSIER-AB16-SLIMDOWN-20260801-DFA55C71DB；DOSSIER-ACCESS-CAPACITY-PROBE-20260822-E9AA72AF77；DOSSIER-ADAPT-BATCH-GATES-EC7F30EDA7；DOSSIER-APX-E-GATE-REVIEW-20260810-1E0BCC6818；DOSSIER-ARM1-OLDWORD-CRAFT-20260823-DA4CC9BECB；DOSSIER-ARM2-SUPPLYSIDE-NEWWORD-20260823-B7F36C02C6；DOSSIER-BASELINE-ARM-