#!/usr/bin/env python3
"""Run the recovered c10 old-count query without persistent /tmp dependencies."""
...
OUTPUT = RECOVERY / "fixed_bays/c10_old_target_9_2_2_20260720.json"
EXPECTED = {
...
def load_source() -> object:
    ...
    spec = importlib.util.spec_from_file_location("c10_old_query_source", SOURCE)
    require(spec is not None and spec.loader is not None, f"cannot load {SOURCE}")
    module = importlib.util.module_from_spec(spec)
    sys.modules["c10_old_query_source"] = module
