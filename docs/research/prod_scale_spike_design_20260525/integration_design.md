...
- `src/cuts/lifecycle.py:1005-1010` (step_8 NotImplementedError)
- `src/cuts/lifecycle.py:438-455` (compute_source_digest)
- `src/cuts/store.py:67-330` (CutStore + 6-dim watcher)
- `src/cuts/replay.py:62-179` (FAMILY_VALIDATORS + replay_cut)
- `src/cuts/oracles/` (9 oracle src)
- `src/cuts/families/` (9 family validator/evaluator)
- `src/models/master_model.py` (PoseBoolExactMaster delegate)
- `src/search/benders_loop.py` (LBBDController, 6067 line)
- `src/search/outer_search.py` (frontier candidate emit)
- `docs/项目说明/09_phase_1_3_plan.md` (P1.3A 3 sub-route)
- `docs/research/phase1_2_gpt_pro_audit_20260525/AUDIT_REPORT.md:257-313` (Finding 5)
- `docs/research/p1_2b_mini_step_8_spike_20260525/` (mini Step 8 spike — what this spike upgrades)
- `data/preprocessed/candidate_placements.json` (真 pose registry)
- `data/preprocessed/mandatory_exact_instances.json` (266 instance)
