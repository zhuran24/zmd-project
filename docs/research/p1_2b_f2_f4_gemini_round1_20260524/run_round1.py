...
PROMPT_HEADER = """你是 LBBD / combinatorial cut / Dinic max-flow / soundness 形式化方法 审查员。这是 Endfield IndustrialPlanner Exact Solver 项目 Phase 1.2 P1.2B-F2/F4 (cutset + component_reach generator + node-split Dinic / BFS helper) 的 **Round 1** 数学+spec-data cross-check。
