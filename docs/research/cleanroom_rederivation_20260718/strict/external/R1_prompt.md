# Independent Architecture Derivation: Round 1
...
Do not browse the web, call connectors, retrieve prior conversations, or use account memory. Work only from the attached files.
