...
当前工作树包含 `candidate_placements.json`，大小 `45,773,799` bytes，SHA256 `adcc2a6e8a1daaa9dea6cae68883301ad07ce123fa286b55dcbe79ca2f34bec0`。其它发行包省略该文件时，必须在运行前恢复相同字节。旧 SHA256 `d5e3911fc1bc7c0ab48d67b981d28e8090741b04884c475e78dc0e128ca4683f` 已被取代。
