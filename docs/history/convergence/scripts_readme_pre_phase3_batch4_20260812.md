...
[`docs/AGENT_OPERATIONS.md`](../docs/AGENT_OPERATIONS.md), the current script `--help`, and
`PROJECT_LOCK.md` authority statements. Use the explicit evidence/replay workflow for
