...
> 原路径：`docs/README.md`。本文件在 2026-08-11 被知识脊柱入口替换后归档。以下正文按原字节内容保留；其中相对链接应按原路径解释，任何“当前”只对快照当时成立。现态请读 [`../../CURRENT.md`](../../CURRENT.md)。
