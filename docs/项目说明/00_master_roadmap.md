...
主体 = active F1-F7+F9 的 production integration（F8 retired）；F1/F5/F6/F7 direct Step-8 已落地，当前按 Stage B B5（B0-B4 已落地,F1/F6/F7 三族纵切全完）与 PIC C/D/E 完成 promotion-grade 链路；三份 2026-07 新增规格在此落地：
