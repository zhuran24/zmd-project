...
### 0b. 方法论：规则归属判据 v2 → v2.5（2026-07-17 三轮推出 v1/v2/v2.1；07-18 两轮补 cut 方法论与四问统一；07-20 干净房间 R2/R3 外部收编；08-03 管线门序泛化；08-03 夜门内归属四则+分层重排）

> **【操作卡·日常入口】本节自 v2.5 起分两层：这张卡是执行入口（按决策时刻排的六问），
