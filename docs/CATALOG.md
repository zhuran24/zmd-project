...
- decision：`8` 条。
- backfill review：`52` 条，其中 current `42` 条。
- dossier：`207` 个，其中 tracked `152` 个、local optional `55` 个、当前证据标记 `16` 个、人工精编 `28` 个。
...
- `witness-lower-bound`：15 个 dossier。
...
- `reasoning-system`：3 个 dossier。
- `solver-architecture`：3 个 dossier。
