#!/usr/bin/env python3
"""Freeze the E037 merged-6x4 shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E037_merged_6x4_assignment/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "e06cb7e2078c398ee2eee4bdf61105bee3d9422a8fca355324f7296d04979640",
    RESULT: "450bd05565afc96cbd071d924405f85d4dc5bc7eee1af4e89cdb574566cfe56f",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e037face_e001", E001_RUNNER)
    e004 = import_module("zmd_e037face_e004", E004_RUNNER)
    e015 = import_module("zmd_e037face_e015", E015_RUNNER)
    audit = import_module("zmd_e037face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E037_BEST_MERGED_6X4_ASSIGNMENT",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e037_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "MERGED_6X4_JOINT_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E037 best-assignment "
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E037 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e037_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
