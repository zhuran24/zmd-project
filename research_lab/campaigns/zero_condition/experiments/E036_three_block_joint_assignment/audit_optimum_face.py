#!/usr/bin/env python3
"""Freeze the E036 three-block shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E036_three_block_joint_assignment/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "a2b263a15a75d446154d7288c8fa499566d8bb565cd95e5c92c01cf782573116",
    RESULT: "e000e1dba3eb3eea208bbc75a8a41eb9faf6001e51eade2308ef43ba6eaff27c",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e036face_e001", E001_RUNNER)
    e004 = import_module("zmd_e036face_e004", E004_RUNNER)
    e015 = import_module("zmd_e036face_e015", E015_RUNNER)
    audit = import_module("zmd_e036face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E036_BEST_THREE_BLOCK_ASSIGNMENT",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e036_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "THREE_BLOCK_JOINT_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E036 best-assignment "
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E036 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e036_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
