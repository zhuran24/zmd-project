#!/usr/bin/env python3
"""Freeze the E030 best operation-swap shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E030_operation_swap_portfolio/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "a6370b2d5fb51416ea9c0825e19c5a526c6b33fa50ccb3a4c52ed3e570d1cd7f",
    RESULT: "2a5c71bd0f6f15a27730c51fd19059efcb14b6aaf63948cc932e7390ccff6b57",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e030face_e001", E001_RUNNER)
    e004 = import_module("zmd_e030face_e004", E004_RUNNER)
    e015 = import_module("zmd_e030face_e015", E015_RUNNER)
    audit = import_module("zmd_e030face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E030_BEST_OPERATION_SWAP",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e030_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "OPERATION_SWAP_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E030 best-swap shared-"
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E030 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e030_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
