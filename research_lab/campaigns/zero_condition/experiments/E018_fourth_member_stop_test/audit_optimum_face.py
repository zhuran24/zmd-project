#!/usr/bin/env python3
"""Freeze the E018 best-fourth shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E018_fourth_member_stop_test/run-001/OPTIMUM_FACE_AUDIT.json"
)
FAILURE = OUT.with_name("OPTIMUM_FACE_AUDIT_FAILURE.json")
BEST_ASSIGNMENT = (
    ROOT
    / "research_lab/local/zero_condition/E018_fourth_member_stop_test/run-001/BEST_FOURTH_ASSIGNMENT.json"
)
RESULT = (
    ROOT
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "7f14bb9b749c18fd24bc4000f55ba161176e7566e7c47aca310ea8acaacbf26b",
    RESULT: "6155248779f6de3e9f17e3a13b07684aacb2c373650510d0b82a81d979a8a06b",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e018face_e001", E001_RUNNER)
    e004 = import_module("zmd_e018face_e004", E004_RUNNER)
    e015 = import_module("zmd_e018face_e015", E015_RUNNER)
    audit = import_module("zmd_e018face_audit", FACE_AUDIT)
    ...
    return {
        "schema": "zmd_zero_condition_e018_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "FOURTH_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E018 best-fourth shared-"
            "objective optimum face only."
        ),
        "ledger_effect": "none",
    }
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E018 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e018_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
