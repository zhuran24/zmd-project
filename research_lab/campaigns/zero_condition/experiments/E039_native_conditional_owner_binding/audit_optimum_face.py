#!/usr/bin/env python3
"""Freeze the E039 faithful native-extension optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E039_native_conditional_owner_binding/run-002/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "aeded115ef1a1983e0fdf9f3decee3d34983d8b53de0f02af5bcb3670cd8cf7b",
    RESULT: "662c2a420fd84a7c9fbbde6c0392d1ce7d726b8c3dcd83e430d299a8a3c93389",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e039face_e001", E001_RUNNER)
    e004 = import_module("zmd_e039face_e004", E004_RUNNER)
    e015 = import_module("zmd_e039face_e015", E015_RUNNER)
    audit = import_module("zmd_e039face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E039_NATIVE_CONDITIONAL_OWNER",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e039_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "NATIVE_CONDITIONAL_OWNER_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E039 best-assignment "
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E039 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e039_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
