#!/usr/bin/env python3
"""Freeze the E017 best-triple shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E017_third_member_portfolio/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "d3c8aed026ddefefdf8da43a3096fac26e89703330dea0d047bc3f9172fd5768",
    RESULT: "08626489854032d7a25097b6b2f1cfacb95444a14c680cee6e7886134f45588d",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e017face_e001", E001_RUNNER)
    e004 = import_module("zmd_e017face_e004", E004_RUNNER)
    e015 = import_module("zmd_e017face_e015", E015_RUNNER)
    audit = import_module("zmd_e017face_audit", FACE_AUDIT)
    ...
    return {
        "schema": "zmd_zero_condition_e017_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "TRIPLE_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E017 best-triple shared-"
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E017 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e017_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
