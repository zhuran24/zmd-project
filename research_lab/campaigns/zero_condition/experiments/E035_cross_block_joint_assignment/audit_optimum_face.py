#!/usr/bin/env python3
"""Freeze the E035 cross-block shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E035_cross_block_joint_assignment/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "1255029fce0320edd0ddb736ba5100bfbc6f5ac19a75c3d27181ba157d0e8efb",
    RESULT: "f2f0939b4fcdcc1b1be8896ad7406b22251a87e807c8b496ef6adf5c4c044b02",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e035face_e001", E001_RUNNER)
    e004 = import_module("zmd_e035face_e004", E004_RUNNER)
    e015 = import_module("zmd_e035face_e015", E015_RUNNER)
    audit = import_module("zmd_e035face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E035_BEST_CROSS_BLOCK_ASSIGNMENT",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e035_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "CROSS_BLOCK_JOINT_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E035 best-assignment "
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E035 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e035_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
