#!/usr/bin/env python3
"""Freeze the two E045 geometry-conditioned joint optimum faces."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E045_revalue_objective146_geometries/"
...
EXPECTED_HASHES = {
    SEED_A_ASSIGNMENT: "06611136869b17cd0ec3b7389e10e56e7d50609358c3988269fd3e47314da729",
    SEED_B_ASSIGNMENT: "216344c1ff593b228e2adf28cd67c04b33c9b7bc28a23c4c5a5793868669bd9f",
    RESULT: "eae3662471f5b7d841effd9351351fdba67c329381ed5c65ddcf9dba839045df",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e045face_e001", E001_RUNNER)
    e004 = import_module("zmd_e045face_e004", E004_RUNNER)
    e015 = import_module("zmd_e045face_e015", E015_RUNNER)
    audit = import_module("zmd_e045face_audit", FACE_AUDIT)
    stack = e001.import_stack()
    inputs = e001.load_model_inputs(stack)
    result = load_json(RESULT)
    seed_a = audit.profile_optimum_face(
        label="E045_GEOMETRY_SEED_A",
    ...
    return {
        "schema": "zmd_zero_condition_e045_optimum_face_audits_v1",
        ...
        "seed_a_face": seed_a,
        "seed_b_face": seed_b,
        "verdict": "OBJECTIVE146_GEOMETRY_OPTIMUM_FACES_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the two fixed E045 best-child shared-"
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E045 optimum-face audits")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e045_optimum_face_audits_failure_v1",
            "created_at_utc": utc_now(),
