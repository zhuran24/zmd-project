#!/usr/bin/env python3
"""Freeze the E041 joint port-mode/assignment shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E041_joint_port_mode_assignment/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "020bfc79e47e61e2c6ccd68d10a7f292d22f381ab0747c3ea37e960f501ce642",
    RESULT: "ba97d01cfe4a757daf102e514ab9984bd99abc679c16f8db6147f2269d40fada",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e041face_e001", E001_RUNNER)
    e004 = import_module("zmd_e041face_e004", E004_RUNNER)
    e015 = import_module("zmd_e041face_e015", E015_RUNNER)
    audit = import_module("zmd_e041face_audit", FACE_AUDIT)
    ...
    face = audit.profile_optimum_face(
        label="E041_JOINT_PORT_MODE_ASSIGNMENT",
        solution=solution,
    ...
    return {
        "schema": "zmd_zero_condition_e041_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "PORT_MODE_JOINT_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E041 best-child shared-"
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E041 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e041_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
