#!/usr/bin/env python3
"""Freeze the E016 best-pair shared-optimum face."""
...
OUT = (
    ROOT
    / "research_lab/local/zero_condition/E016_coupled_pair_search/run-001/OPTIMUM_FACE_AUDIT.json"
)
...
EXPECTED_HASHES = {
    BEST_ASSIGNMENT: "aa92cf0328df49c3c2d058b96c0fd941ceba2436859823e15d85b0792d4c5403",
    RESULT: "1a6c85a6db935237c5d0df8666d47b1df36dce59ddaec5ab585883d5e13ca161",
...
def run() -> dict[str, Any]:
    ...
    e001 = import_module("zmd_e016face_e001", E001_RUNNER)
    e004 = import_module("zmd_e016face_e004", E004_RUNNER)
    e015 = import_module("zmd_e016face_e015", E015_RUNNER)
    audit = import_module("zmd_e016face_audit", FACE_AUDIT)
    ...
    return {
        "schema": "zmd_zero_condition_e016_optimum_face_audit_v1",
        ...
        "face": face,
        "verdict": "PAIR_OPTIMUM_FACE_EXACT",
        "truth_boundary": (
            "Exact per-commodity ranges over the fixed E016 best-pair shared-"
...
def main() -> int:
    if OUT.exists() or FAILURE.exists():
        raise FileExistsError("refusing to overwrite E016 optimum-face audit")
    try:
        result = run()
        ...
        failure = {
            "schema": "zmd_zero_condition_e016_optimum_face_audit_failure_v1",
            "created_at_utc": utc_now(),
