...
- Inventory: `/mnt/data/work/full/exact_refactor_project_20260414_single_base_scope/data/examples/industrial_planner/full_demand_support_suite_inventory.json`
...
|---|---|---|---:|---:|---|---:|---:|---:|---:|
| `default_full_demand_support_suite` | `default_contract_scope` | `/mnt/data/work/full/exact_refactor_project_20260414_single_base_scope/data/examples/industrial_planner` | 1 | 5 | `clean` | 6 | 1 | 0 | 0 |
## Operational notes
