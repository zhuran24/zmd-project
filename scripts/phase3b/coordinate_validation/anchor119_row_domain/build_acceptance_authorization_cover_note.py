...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.acceptance_authorization_cover_note import (
    build_phase3b_coordinate_validation_anchor119_row_domain_acceptance_authorization_cover_note,
    write_phase3b_coordinate_validation_anchor119_row_domain_acceptance_authorization_cover_note,
)
...
def main() -> int:
    ...
    if args.no_write:
        ...
        cover_note = report.get("acceptance_authorization_cover_note", {})
        locked_execution_target = cover_note.get("locked_execution_target", {})
        print("phase3b anchor119 row-domain acceptance authorization cover note")
        print(
            "acceptance_authorization_cover_note_ready="
            + str(bool(status.get("acceptance_authorization_cover_note_ready", False)))
        )
        print(
    ...
    print(
        "anchor119_row_domain_acceptance_authorization_cover_note_md="
        + str(Path(written["md"]).resolve())
    )
    print(
        "anchor119_row_domain_acceptance_authorization_cover_note_txt="
