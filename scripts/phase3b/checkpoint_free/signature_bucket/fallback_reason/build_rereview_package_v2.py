...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "fallback_reason" / "build_external_review_package.py",
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "fallback_reason" / "build_readiness.py",
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "build_s64_fail_closed_hardening.py",
    "s67_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "fallback_reason" / "build_rereview_package_v2.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/fallback_reason/build_readiness.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/fallback_reason/build_review.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_s64_fail_closed_hardening.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/fallback_reason/build_rereview_package_v2.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_readiness.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_review.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_rereview_package_v2.py",
