...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "payload_footprint" / "build_stability_strategy.py",
    "s84_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "payload_footprint" / "build_stability_external_review_package.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/payload_footprint/build_stability_strategy.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/payload_footprint/build_stability_external_review_package.py",
...
def _package_path_for_input(key: str) -> Path:
    mapping = {
        ...
        "s79_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/template_footprint/build_support_gap_probe_readiness.py"),
        "s80_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/template_footprint/build_support_gap_probe_review.py"),
        "s81_package_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/template_footprint/build_support_gap_probe_external_review_package.py"),
        "s83_strategy_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/payload_footprint/build_stability_strategy.py"),
        "s84_package_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/payload_footprint/build_stability_external_review_package.py"),
        "s79_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/template_footprint/test_support_gap_probe_readiness.py"),
        "s80_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/template_footprint/test_support_gap_probe_review.py"),
        "s81_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/template_footprint/test_support_gap_probe_external_review_package.py"),
        "s83_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/payload_footprint/test_stability_strategy.py"),
        "s84_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/payload_footprint/test_stability_external_review_package.py"),
    }
    return mapping[key]
