    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "changed_files": [
            ...
            "src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_review.py",
            ...
            "src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_rereview_package_v2.py",
        ],
        "verification": [
            {
            ...
            {
                "command": "pytest src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_review.py -q",
                "status": "passed",
            },
            {
                "command": "pytest src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_rereview_package_v2.py -q",
                "status": "passed",
            },
            {
                "command": "pytest src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_readiness.py src/tests/phase3b/checkpoint_free/signature_bucket/fallback_reason/test_external_review_package.py -q",
                "status": "passed",
            },
            {
