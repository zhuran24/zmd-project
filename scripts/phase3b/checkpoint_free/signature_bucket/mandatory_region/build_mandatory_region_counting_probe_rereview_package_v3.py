...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "build_s53_fail_closed_hardening.py",
    "s58_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "mandatory_region" / "build_mandatory_region_counting_probe_rereview_package_v3.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_s53_fail_closed_hardening.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_region_counting_probe_rereview_package_v3.py",
        ...
        "test_context/src/tests/phase3b/checkpoint_free/overlay_timing/test_probe.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/mandatory_region/test_mandatory_region_counting_probe_rereview_package_v3.py",
...
def _package_path_for_input(key: str) -> Path:
    mapping = {
        ...
        "s52_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_region_counting_probe_readiness.py"),
        "s53_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_region_counting_probe_review.py"),
        "overlay_timing_probe": Path("code_context/scripts/run_phase3b_checkpoint_free_overlay_timing_probe.py"),
        "s57_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_s53_fail_closed_hardening.py"),
        "s58_package_builder": Path("code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_region_counting_probe_rereview_package_v3.py"),
        "s52_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/mandatory_region/test_mandatory_region_counting_probe_readiness.py"),
        "s53_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/mandatory_region/test_mandatory_region_counting_probe_review.py"),
        "overlay_timing_probe_tests": Path("test_context/src/tests/phase3b/checkpoint_free/overlay_timing/test_probe.py"),
        "s58_tests": Path("test_context/src/tests/phase3b/checkpoint_free/signature_bucket/mandatory_region/test_mandatory_region_counting_probe_rereview_package_v3.py"),
