...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "mandatory_region" / "build_mandatory_scan_strategy.py",
    "s50_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "mandatory_region" / "build_mandatory_scan_external_review_package.py",
    "s48_review_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "visibility" / "build_probe_review.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_scan_strategy.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_scan_external_review_package.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/visibility/build_probe_review.py",
