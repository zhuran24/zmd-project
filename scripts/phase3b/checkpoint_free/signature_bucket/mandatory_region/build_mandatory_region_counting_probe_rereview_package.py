...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "mandatory_region" / "build_mandatory_region_counting_probe_rereview_package.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/mandatory_region/build_mandatory_region_counting_probe_rereview_package.py",
        ...
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/mandatory_region/test_mandatory_region_counting_probe_rereview_package.py",
