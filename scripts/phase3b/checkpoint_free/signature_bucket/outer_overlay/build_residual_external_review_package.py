...
PACKAGE_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "residual_overlay" / "build_probe_readiness.py",
    "s97_review_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "residual_overlay" / "build_probe_review.py",
    "s100_s101_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "outer_overlay" / "build_residual_external_review_package.py",
