...
DEFAULT_INPUTS = {
    ...
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "tightening" / "build_strategy.py",
    "s37_patch_spec_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "tightening" / "build_instrumentation_patch_spec.py",
    "s38_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "build_external_review_package.py",
    "s39_revision_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "build_patch_spec_revision.py",
    "s40_package_builder": PROJECT_ROOT
    / "scripts" / "phase3b" / "checkpoint_free" / "signature_bucket" / "build_external_review_package_v2.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/tightening/build_strategy.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/tightening/build_instrumentation_patch_spec.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_external_review_package.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_patch_spec_revision.py",
        "code_context/scripts/phase3b/checkpoint_free/signature_bucket/build_external_review_package_v2.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/test_external_review_package.py",
        "test_context/src/tests/phase3b/checkpoint_free/signature_bucket/test_patch_spec_revision.py",
