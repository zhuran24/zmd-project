...
DEFAULT_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_visibility_path_strategy.py",
    "s45_package_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_visibility_path_external_review_package.py",
    "s43_review_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_enabled_no_solve_probe_review.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_visibility_path_strategy.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_visibility_path_external_review_package.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_enabled_no_solve_probe_review.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_visibility_path_strategy.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_visibility_path_external_review_package.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_enabled_no_solve_probe_review.py",
