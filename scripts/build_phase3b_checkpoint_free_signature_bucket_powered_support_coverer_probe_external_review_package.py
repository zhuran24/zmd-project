...
PACKAGE_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_powered_support_coverer_probe_readiness.py",
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_powered_support_coverer_probe_external_review_package.py",
