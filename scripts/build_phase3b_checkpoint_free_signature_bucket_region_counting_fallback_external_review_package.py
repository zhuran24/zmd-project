...
DEFAULT_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_strategy.py",
    "s61_package_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_external_review_package.py",
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_strategy.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_external_review_package.py",
        ...
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_strategy.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_region_counting_fallback_external_review_package.py",
