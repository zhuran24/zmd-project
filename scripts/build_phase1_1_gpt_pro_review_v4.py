#!/usr/bin/env python3
"""Build phase1_1_gpt_pro_review_v4.zip for GPT pro Phase 1.1 Step A-H audit.
...
OUT_DIR = Path("/tmp/_phase1_1_pkg_v4")
OUT_ZIP = Path("/home/zhuran24/linwin_share/phase1_1_gpt_pro_review_v4.zip")
...
CHANGELOG = """# Commit log (Phase 1.1 Step A-L)

12 commit (含 2 build-script infra commit). 每 commit message 在 git log (commit hash 列).
...
| a38620c | families/region_capacity.py + test_family_region_capacity.py + tests F401 cleanup | F1 contributing_groups 去重 + tuple demand check + gap consistency; ruff F401 12 个清 |
"""
