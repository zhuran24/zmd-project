#!/usr/bin/env python3
"""Build phase1_1_gpt_pro_review_v5.zip for GPT pro Phase 1.1 Step A-H audit.
...
OUT_DIR = Path("/tmp/_phase1_1_pkg_v5")
OUT_ZIP = Path("/home/zhuran24/linwin_share/phase1_1_gpt_pro_review_v5.zip")
...
CHANGELOG = """# Commit log (Phase 1.1 Step A-M)

14 commit (含 3 build-script infra commit). 每 commit message 在 git log (commit hash 列).
