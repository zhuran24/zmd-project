...
CHANGELOG = """# Commit log (Phase 1.1 Step A-H)

8 commit modifying src/cuts/. 每 commit message 在 git log (commit hash 列).
...
└── external_review/                 # GPT pro audit archives (round 1, 2)
