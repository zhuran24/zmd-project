...
Current frozen inputs include `canonical_rules.json` at 18,137 bytes / SHA256
`c3666d78d5dd1329514c7813be9f91f09cb3ce7b94907ef5b6ce746c9bcbbbd5`, `preprocess_plan.json`
