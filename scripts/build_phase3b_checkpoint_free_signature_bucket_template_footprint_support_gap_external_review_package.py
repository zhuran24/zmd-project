...
DEFAULT_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_template_footprint_probe_external_review_package.py",
    "s76_strategy_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_strategy.py",
    "s77_package_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_external_review_package.py",
...
def _validate_clean_extraction(
    *,
    ...
    s76_builder_text = (
        extract_dir
        / "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_strategy.py"
    ).read_text(encoding="utf-8")
    semantic_checks = {
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_template_footprint_probe_external_review_package.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_strategy.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_external_review_package.py",
        ...
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_template_footprint_probe_external_review_package.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_strategy.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_template_footprint_support_gap_external_review_package.py",
    ]
