...
PACKAGE_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_powered_support_compact_item_batched_counter_probe_readiness.py",
    "s140_review_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_powered_support_compact_item_batched_counter_probe_review.py",
    "s141_package_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_powered_support_compact_item_batched_counter_probe_external_review_package.py",
