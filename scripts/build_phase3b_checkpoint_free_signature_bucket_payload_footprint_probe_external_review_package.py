...
DEFAULT_INPUTS = {
    ...
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_readiness.py",
    "s87_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_review.py",
    "s88_package_builder": PROJECT_ROOT
    / "scripts"
    / "build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_external_review_package.py",
...
def _validate_clean_extraction(
    *,
    ...
    s87_builder_text = (
        extract_dir
        / "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_review.py"
...
def _required_entries() -> list[str]:
    return [
        ...
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_readiness.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_review.py",
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_external_review_package.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_readiness.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_review.py",
        "test_context/src/tests/test_phase3b_checkpoint_free_signature_bucket_payload_footprint_probe_external_review_package.py",
    ]
