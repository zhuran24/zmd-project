"""Small terminal-frontier proof core for the PR2 L0 verifier child."""
...
_RUN_STATUS_CERTIFIED = "CERTIFIED"
_RUN_STATUS_INFEASIBLE = "INFEASIBLE"
...
__all__ = (
    ...
    "TERMINAL_FRONTIER_EVIDENCE_SCHEMA_VERSION",
    "TERMINAL_FRONTIER_EVIDENCE_SOURCE",
    "TERMINAL_FRONTIER_EXHAUSTED_REASON",
    ...
    "candidate_key",
    "candidate_key_from_dimensions",
    "candidate_objective",
    "candidate_sort_key",
    "compute_terminal_frontier_projection",
    "generate_candidate_sizes",
    "normalize_candidate_generation_params",
...
def compute_terminal_frontier_projection(
    *,
    ...
    for candidate in normalized_candidates:
        ...
        if status == _RUN_STATUS_CERTIFIED:
        ...
        elif status == _RUN_STATUS_INFEASIBLE:
    ...
    for candidate in normalized_candidates:
        ...
        if status in {_RUN_STATUS_CERTIFIED, _RUN_STATUS_INFEASIBLE}:
            continue
...
def _candidate_status_digest(
    *,
    ...
    for candidate in candidates:
        ...
        if isinstance(record, Mapping) and status == _RUN_STATUS_CERTIFIED:
