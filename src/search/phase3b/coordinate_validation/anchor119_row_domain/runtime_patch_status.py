...
def build_phase3b_coordinate_validation_anchor119_row_domain_runtime_patch_status(
    ...
    *,
    ...
    # After 2026-05-16 phase3b reorganization, sibling modules now live in
    # neighbouring cluster dirs under src/search/phase3b/.
    _phase3b_root = Path(__file__).resolve().parents[2]
    controls_module_path = _phase3b_root / "anchor119" / "guard_controls.py"
    runtime_module_path = _phase3b_root / "anchor119" / "guarded_precheck_runtime.py"
    benders_loop_path = _phase3b_root.parent / "benders_loop.py"
