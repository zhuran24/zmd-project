...
import src.search.phase3b_coordinate_validation_actual_path_assumption_core as actual_module
...
def test_actual_path_assumption_core_cli_writes_and_no_write_skips_output(
    ...
    script = (
        repo_root
        / "scripts"
        / "build_phase3b_coordinate_validation_actual_path_assumption_core.py"
    )
