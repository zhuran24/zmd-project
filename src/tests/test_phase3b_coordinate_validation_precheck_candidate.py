...
from src.search.phase3b_coordinate_validation_precheck_candidate import (
...
def test_coordinate_validation_precheck_candidate_cli_writes_and_no_write_skips(
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_precheck_candidate.py"
