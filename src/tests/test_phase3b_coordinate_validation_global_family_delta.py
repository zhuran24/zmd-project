...
import src.search.phase3b_coordinate_validation_global_family_delta as delta_module
...
def test_global_family_delta_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_global_family_delta.py"
