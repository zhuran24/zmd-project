...
import src.search.phase3b_selected_block_equivalence as audit_module
from src.search.phase3b_selected_block_equivalence import (
...
def test_selected_block_equivalence_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_selected_block_equivalence.py"
