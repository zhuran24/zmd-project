...
from src.search.phase3b_coordinate_validation_anchor119_row_domain_guard_spec import (
...
def test_anchor119_row_domain_guard_spec_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts"
        / "build_phase3b_coordinate_validation_anchor119_row_domain_guard_spec.py"
    )
