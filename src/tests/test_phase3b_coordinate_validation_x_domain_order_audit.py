...
import src.search.phase3b_coordinate_validation_x_domain_order_audit as audit_module
...
def test_x_domain_order_audit_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_x_domain_order_audit.py"
