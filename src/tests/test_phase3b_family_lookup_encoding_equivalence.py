...
import src.search.phase3b_family_lookup_encoding_equivalence as audit_module
...
def test_family_lookup_encoding_equivalence_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_family_lookup_encoding_equivalence.py"
