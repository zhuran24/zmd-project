...
from scripts.build_phase3b_checkpoint_free_signature_bucket_external_review_package import (
...
def test_signature_bucket_external_review_package_builds_zip_and_validates_clean_extraction(
    ...
    assert "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_tightening_strategy.py" in names
    assert (
        "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_tightening_instrumentation_patch_spec.py"
        in names
    )
    assert "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_external_review_package.py" in names
...
def test_signature_bucket_external_review_package_fails_when_review_wording_is_missing(
    ...
    monkeypatch.setattr(
        "scripts.build_phase3b_checkpoint_free_signature_bucket_external_review_package.REVIEW_WORDING_REQUIREMENTS",
