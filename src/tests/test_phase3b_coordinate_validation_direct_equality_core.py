...
import src.search.phase3b_coordinate_validation_direct_equality_core as core_module
...
def test_direct_equality_core_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_direct_equality_core.py"
