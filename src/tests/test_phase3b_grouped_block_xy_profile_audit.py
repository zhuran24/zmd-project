...
import src.search.phase3b_grouped_block_xy_profile_audit as audit_module
from src.search.phase3b_grouped_block_xy_profile_audit import (
...
def test_grouped_block_xy_profile_audit_cli_surface_mentions_outputs() -> None:
    ...
    script = repo_root / "scripts" / "build_phase3b_grouped_block_xy_profile_audit.py"
