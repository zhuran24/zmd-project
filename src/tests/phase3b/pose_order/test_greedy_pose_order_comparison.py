...
import src.search.phase3b.pose_order.greedy_pose_order_comparison as comparison_module
...
def test_greedy_pose_order_comparison_cli_writes_and_no_write_skips(
    ...
    script = repo_root / "scripts" / "phase3b" / "pose_order" / "build_greedy_pose_order_comparison.py"
