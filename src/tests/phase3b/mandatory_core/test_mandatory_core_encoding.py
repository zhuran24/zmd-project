...
import src.search.phase3b.mandatory_core.mandatory_core_encoding as encoding_module
...
def test_mandatory_core_encoding_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "mandatory_core" / "build_mandatory_core_encoding.py"
