...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.acceptance_result_validator import (
...
from src.tests.phase3b.b5a.test_certified_anchor_promotion_review_packet import (
    _valid_promotion_payload,
    _write_valid_chain,
)
from src.tests.phase3b.coordinate_validation.anchor119_row_domain.test_acceptance_result_validator import (
...
def test_preflight_cli_does_not_emit_non_dry_run_command_when_ready(
    ...
    script_path = (
        ...
        / "scripts" / "phase3b" / "long_run" / "build_preflight.py"
    )
...
def test_preflight_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    project_root = _build_exact_project(tmp_path / "project")
    script_path = Path(__file__).resolve().parents[4] / "scripts" / "phase3b" / "long_run" / "build_preflight.py"
