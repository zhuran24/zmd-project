...
import src.search.phase3b.full_forced_hint.field_family_delta as delta_module
from src.search.phase3b.full_forced_hint.field_family_delta import (
...
def test_full_forced_hint_delta_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "full_forced_hint" / "build_field_family_delta.py"
