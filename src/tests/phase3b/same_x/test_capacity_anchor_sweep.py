...
import src.search.phase3b.same_x.capacity_anchor_sweep as sweep_module
from src.search.phase3b.same_x.capacity_anchor_sweep import (
...
def test_same_x_capacity_anchor_sweep_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "same_x" / "build_capacity_anchor_sweep.py"
