...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.pre_run_acceptance_validation import (
...
from src.search.phase3b.long_run.preflight import _prod_4x4_record_valid
...
def test_anchor119_row_domain_pre_run_acceptance_validation_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "anchor119_row_domain" / "build_pre_run_acceptance_validation.py"
    )
