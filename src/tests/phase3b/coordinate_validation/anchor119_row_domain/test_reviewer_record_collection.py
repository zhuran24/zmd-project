...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.reviewer_record_collection import (
...
def test_anchor119_row_domain_reviewer_record_collection_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "anchor119_row_domain" / "build_reviewer_record_collection.py"
    )
