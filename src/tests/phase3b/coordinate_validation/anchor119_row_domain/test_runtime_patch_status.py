...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.runtime_patch_status import (
...
def test_anchor119_row_domain_runtime_patch_status_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "anchor119_row_domain" / "build_runtime_patch_status.py"
    )
