...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.acceptance_execution_staging import (
...
def test_anchor119_row_domain_acceptance_execution_staging_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "anchor119_row_domain" / "build_acceptance_execution_staging.py"
    )
