...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.ingest_review_cover_note import (
...
def test_anchor119_row_domain_ingest_review_cover_note_cli_write_and_no_write(
    ...
    script_path = (
        ...
        / "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_ingest_review_cover_note.py"
    )
    env = dict(os.environ)
