...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.ingest_review_record_example_bundle import (
...
def test_anchor119_row_domain_ingest_review_record_example_bundle_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "anchor119_row_domain" / "build_ingest_review_record_example_bundle.py"
    )
