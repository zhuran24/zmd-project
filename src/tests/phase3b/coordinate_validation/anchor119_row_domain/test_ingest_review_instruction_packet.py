...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.ingest_review_instruction_packet import (
    ...
    return {
        ...
        "ingest_review_operator_handoff_bundle": {
            ...
            "validator_script_or_artifact_reference": {
                ...
                "builder_script_path": "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_ingest_review_record_validator.py",
            ...
            "example_bundle_reference": {
                ...
                "builder_script_path": "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_ingest_review_record_example_bundle.py",
...
def _example_bundle_json() -> dict:
    return {
        ...
        "ingest_review_record_example_bundle": {
            ...
            "replay_instructions": {
                "validator_script": "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_ingest_review_record_validator.py",
                "validator_target": "future_completed_ingest_review_record_payload",
            },
            "preserved_state_assertions": {
                "repo_side_review_state_updated": False,
...
def test_anchor119_row_domain_ingest_review_instruction_packet_cli_write_and_no_write(
    ...
    script_path = (
        ...
        / "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_ingest_review_instruction_packet.py"
    )
    env = dict(os.environ)
