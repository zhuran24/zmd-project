...
from src.search.phase3b.coordinate_validation.anchor119_row_domain.manual_review_package_index import (
...
def test_anchor119_manual_review_package_index_cli_write_and_no_write(
    ...
    script_path = (
        ...
        / "scripts/phase3b/coordinate_validation/anchor119_row_domain/build_manual_review_package_index.py"
    )
    env = dict(os.environ)
