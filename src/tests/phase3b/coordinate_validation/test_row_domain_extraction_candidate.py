...
from src.search.phase3b.coordinate_validation.row_domain_extraction_candidate import (
...
def test_row_domain_extraction_candidate_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "build_row_domain_extraction_candidate.py"
    )
