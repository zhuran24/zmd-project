...
import src.search.phase3b.coordinate_validation.field_channel_delta as field_module
...
def test_field_channel_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "phase3b" / "coordinate_validation" / "build_field_channel_delta.py"
