...
import src.search.phase3b.coordinate_validation.actual_path_equality_core as actual_module
from src.search.phase3b.coordinate_validation.actual_path_equality_core import (
...
def test_actual_path_equality_core_cli_writes_and_no_write_skips_output(
    ...
    script = (
        repo_root
        / "scripts" / "phase3b" / "coordinate_validation" / "build_actual_path_equality_core.py"
    )
