...
import src.search.phase3b.coordinate_validation.target_ghost_capacity_repro as repro_module
...
def test_target_ghost_capacity_repro_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "phase3b" / "coordinate_validation" / "build_target_ghost_capacity_repro.py"
