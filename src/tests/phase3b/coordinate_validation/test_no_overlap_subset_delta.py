...
import src.search.phase3b.coordinate_validation.no_overlap_subset_delta as delta_module
...
def test_no_overlap_delta_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "phase3b" / "coordinate_validation" / "build_no_overlap_subset_delta.py"
