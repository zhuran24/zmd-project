...
from src.search.phase3b.protocol import protocol_target_channel_slot_audit as audit
...
def test_cli_no_write_with_missing_campaign_does_not_create_output(tmp_path) -> None:
    ...
    script = project_root / "scripts" / "phase3b" / "protocol" / "build_protocol_target_channel_slot_audit.py"
