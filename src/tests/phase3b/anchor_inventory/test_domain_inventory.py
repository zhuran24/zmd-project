...
import src.search.phase3b.anchor_inventory.domain_inventory as domain_module
from src.search.phase3b.anchor_inventory.domain_inventory import (
...
def test_anchor_domain_inventory_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "anchor_inventory" / "build_domain_inventory.py"
