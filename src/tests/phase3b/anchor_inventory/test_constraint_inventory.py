...
import src.search.phase3b.anchor_inventory.constraint_inventory as inventory_module
...
def test_anchor_constraint_inventory_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "anchor_inventory" / "build_constraint_inventory.py"
