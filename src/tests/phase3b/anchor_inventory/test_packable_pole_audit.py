...
import src.search.phase3b.anchor_inventory.packable_pole_audit as audit_module
...
def test_cli_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "phase3b" / "anchor_inventory" / "build_packable_pole_audit.py"
