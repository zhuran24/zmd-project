...
import src.search.phase3b.cover.literal_scale_estimate as scale_module
from src.search.phase3b.cover.literal_scale_estimate import (
...
def test_cover_literal_scale_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "phase3b" / "cover" / "build_literal_scale_estimate.py"
