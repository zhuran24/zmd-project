...
import src.search.phase3b.residual_optional.residual_optional_encoding as encoding_module
...
def test_residual_optional_encoding_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "phase3b" / "residual_optional" / "build_residual_optional_encoding.py"
