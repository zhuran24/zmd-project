...
from scripts.build_phase3b_checkpoint_free_signature_bucket_powered_support_coverer_external_review_package import (
...
def _write_fixture_tree(root: Path) -> dict[str, Path]:
    ...
    _write_context_file(
        root
        / "scripts"
        / "build_phase3b_checkpoint_free_signature_bucket_powered_support_coverer_external_review_package.py"
    )
    _write_context_file(
        root
        / "src"
