...
from src.search.phase3b_coordinate_validation_anchor119_row_domain_ingest_review_record_scaffold import (
...
def test_anchor119_row_domain_ingest_review_record_scaffold_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts"
        / "build_phase3b_coordinate_validation_anchor119_row_domain_ingest_review_record_scaffold.py"
    )
