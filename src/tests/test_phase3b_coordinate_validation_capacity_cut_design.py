...
import src.search.phase3b_coordinate_validation_capacity_cut_design as design_module
from src.search.phase3b_coordinate_validation_capacity_cut_design import (
...
def test_capacity_cut_design_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_capacity_cut_design.py"
