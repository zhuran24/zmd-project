...
from scripts.build_phase3b_checkpoint_free_next_decision import (
...
def test_next_decision_runs_no_solve_enforced_probe_after_ghost_strategy(
    ...
    assert "build_phase3b_checkpoint_free_master_proto_inventory.py" in gate["command_template"]
