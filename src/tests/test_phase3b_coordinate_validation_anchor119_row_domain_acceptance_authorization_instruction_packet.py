...
from src.search.phase3b_coordinate_validation_anchor119_row_domain_acceptance_authorization_instruction_packet import (
...
def test_anchor119_row_domain_acceptance_authorization_instruction_packet_cli(
    ...
    script_path = (
        ...
        / "scripts"
        / "build_phase3b_coordinate_validation_anchor119_row_domain_"
        "acceptance_authorization_instruction_packet.py"
    )
    project_root = tmp_path / "project"
    handoff_path, validator_path, example_bundle_path = _build_ready_upstream_artifacts(
        tmp_path
