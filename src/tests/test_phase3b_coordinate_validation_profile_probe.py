...
import src.search.phase3b_coordinate_validation_profile_probe as probe_module
...
def test_coordinate_validation_profile_probe_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_profile_probe.py"
