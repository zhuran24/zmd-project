...
from src.search.phase3b_coordinate_validation_order_capacity_certificate_candidate import (
...
def test_order_capacity_certificate_candidate_cli_writes_and_no_write_skips(
    ...
    script = (
        repo_root
        / "scripts"
        / "build_phase3b_coordinate_validation_order_capacity_certificate_candidate.py"
    )
