...
import src.search.phase3b_coordinate_validation_assumption_core as core_module
...
def test_assumption_core_cli_writes_and_no_write_skips_output(tmp_path: Path) -> None:
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_assumption_core.py"
