...
import src.search.phase3b_forced_anchor_presolve_profile_probe as probe_module
...
def test_forced_anchor_presolve_profile_probe_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_forced_anchor_presolve_profile_probe.py"
