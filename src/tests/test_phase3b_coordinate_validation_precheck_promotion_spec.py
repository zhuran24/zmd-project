...
from src.search.phase3b_coordinate_validation_precheck_promotion_spec import (
...
def test_coordinate_promotion_spec_cli_no_write_and_default_write(
    ...
    script = repo_root / "scripts" / "build_phase3b_coordinate_validation_precheck_promotion_spec.py"
