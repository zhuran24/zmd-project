...
from src.search.phase3b_coordinate_validation_anchor119_row_domain_delivery_note import (
...
def test_anchor119_row_domain_delivery_note_cli_write_and_no_write(
    ...
    script_path = (
        ...
        / "scripts"
        / "build_phase3b_coordinate_validation_anchor119_row_domain_delivery_note.py"
    )
    project_root = tmp_path / "project"
    package_index_path, final_handoff_path = _build_ready_upstream_artifacts(tmp_path)
