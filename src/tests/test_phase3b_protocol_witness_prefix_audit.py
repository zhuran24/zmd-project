...
import src.search.phase3b_protocol_witness_prefix_audit as audit_module
from src.search.phase3b_protocol_witness_prefix_audit import (
...
def test_protocol_witness_prefix_audit_cli_writes_and_no_write_skips_output(
    ...
    script = repo_root / "scripts" / "build_phase3b_protocol_witness_prefix_audit.py"
    project_root = tmp_path / "project"
