...
from scripts.build_phase3b_checkpoint_free_signature_bucket_fallback_reason_probe_rereview_package_v2 import (
    DEFAULT_RUN_ID,
...
def test_fallback_reason_probe_rereview_package_v2_manifest_contains_context(
    ...
    assert "code_context/scripts/build_phase3b_checkpoint_free_signature_bucket_fallback_reason_probe_rereview_package_v2.py" in names
