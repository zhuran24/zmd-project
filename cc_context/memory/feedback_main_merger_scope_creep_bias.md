...
description: "Main merger 8 路 design 取交集时 default 偏 correctness/integration override simplicity, leak phase boundary 进下一 phase 主体. user 是唯一 catch 这层 audit 的人 (Gemini 数学/paradigm 强但 phase boundary audit 没 strong opinion). simplicity slant explicit 划界时必 listen, 不 fold 成隐性 N=1."
metadata: 
  node_type: memory
  type: feedback
