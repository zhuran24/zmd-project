...
R=Path.cwd();O=R/'内核维护/2026-09-22c';source=R/'数据/样例/任务7内核/无线多格全收.json'
...
d['catalog']['sha256']='c252c5fae915e2e4002869d7830fff61a50407c47c2ffd9fa855ad0fc893879d';p=O/'stale-catalog-input.json';save(p,d)
