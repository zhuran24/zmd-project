...
def main():
    ...
    wall=verify(read(ROUNDS/'第69-71轮/推导69/wall0_certificate.json'),None)
    assert (wall['columns'],wall['rows'],wall['upper'])==(550,1352,'1846/135')
    print('wall',wall,flush=True)
    local={}; audits=[]
    for cert in read(ROUNDS/'第69-71轮/推导69/supply_strip_certificates.json'):
    ...
    capacities=[]; nc=0
    for cert in read(ROUNDS/'第66-68轮/推导66/power_certificates.json')['17']:
