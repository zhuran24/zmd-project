...
def build(spec, W, H, threads=6, tlimit=60, minimize=True, seed=0, hint=None, fixed=None):
...
if __name__ == "__main__":
    ...
    r = build(spec, a.W, a.H, threads=a.threads, tlimit=a.t, minimize=not a.nomin, fixed=fixed)
    r["k"] = a.k
