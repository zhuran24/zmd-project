...
def build(name, local_units, intents, routes, assertion):
    ...
    data = {
        ...
        'settings': {'anchor': anchor, 'switches': [{'unit': u['id'], 'function': fn, 'enabled': True} for u in units for fn in kinds[u['kind']]['powered_functions']], 'gates': [], 'warehouse_assignments': []},
...
def main():
    build('桥接器双通路', [
        unit('south_box', '协议储存箱', 9, 7), unit('bridge', '桥接器', 11, 10),
        unit('north_box', '协议储存箱', 11, 11), unit('west_box', '协议储存箱', 8, 10, 'r270'),
        unit('east_box', '协议储存箱', 12, 8, 'r270'), unit('power', '供电桩', 16, 10)], [], [
    ...
    build('分流器三路轮询', [
        unit('south_box', '协议储存箱', 19, 17), unit('splitter', '分流器', 21, 20),
        unit('north_box', '协议储存箱', 21, 21), unit('east_box', '协议储存箱', 22, 18, 'r270'),
        unit('west_box', '协议储存箱', 18, 20, 'r90'), unit('power', '供电桩', 25, 18),
        unit('bottom_source', '仓库取货口', 3, 0), unit('left_source', '仓库取货口', 0, 3, 'r270')], [], [
    ...
    build('混做粉碎机两下游', [
        unit('crusher', '粉碎机', 30, 2), unit('grinder_a', '研磨机', 26, 8), unit('grinder_b', '研磨机', 33, 8), unit('power', '供电桩', 34, 3), unit('ore_source', '仓库取货口', 29, 0), unit('feed_belt', '传送带', 30, 1),
        ...
        [('crusher:north:0', 'belt_a0:south:0'), ('belt_a0:north:0', 'belt_a1:south:0'), ('belt_a1:north:0', 'belt_a2:south:0'), ('belt_a2:north:0', 'grinder_a:south:4')],
