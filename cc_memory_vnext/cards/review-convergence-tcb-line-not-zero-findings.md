...
== 三澄清(owner 2026-07-06,P1.2 方案完整性评估后的两拍板)==
- **收口前提范围补齐**:上段括号句"(#2/#3/#8/#9b 等是否也是收口前提 owner 未逐一明确;至少 #1 是)"已被 owner 亲答**"算"**关闭——收口前提=**整条 backlog 编码项**(#8、#2/#3、#5-B2、#5-F spike、#1、#9b/#9c),收口外审排阶段4 之后;#9a 生产字节重钉维持部署时点、不阻塞收口判定。
