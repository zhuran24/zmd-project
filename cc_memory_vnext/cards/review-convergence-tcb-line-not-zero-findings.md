...
provenance:
  ...
  evidence:
    ...
    - "2026-07-06:P1.2 方案完整性评估指出两处悬空(收口前提集合未闭合、'三连 clean'与画线哲学两套逻辑并存),owner 两拍板关闭:#2/#3/#8/#9b 均算收口前提(收口前提=全 backlog 编码项);'三连'是图方便说法非硬判据,实际=外审到 owner 判定合适为止。据此补'三澄清'段。"
