...
3. **推不动真瓶颈**:项目真卡着的是 owner 手动 review 门(P1.2 close,repo 外计数、只 owner 能推)。TCB 再硬化那门也不自动开。力气花这儿,项目没往"完成"挪一步。
