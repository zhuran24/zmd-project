...
- 都属**真·深化**(改认证核心 sealed 代码 + reseal);**#1 是 P1.2 收口的前提,现在就做**(owner 2026-07-04 晚修正:先做 #1 再收口,不是先收口后深化;07-06 再扩:整条 backlog 编码项均为收口前提、不只 #1;详见 [[review-convergence-tcb-line-not-zero-findings]] "再澄清"+"三澄清"段)。#5-F part3 的 soundness 虽有 V99 floor 兜底(C interim),但 #1 最小 TCB 闭包本身是收口前提。
