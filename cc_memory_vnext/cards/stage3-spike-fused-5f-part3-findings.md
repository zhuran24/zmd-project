...
- 都属**真·深化**(改认证核心 sealed 代码 + reseal);**#1 曾是 P1.2 收口前提**(owner 2026-07-04 晚修正:先做 #1 再收口;07-06 早间曾扩"全 backlog=前提"、同日晚间收窄:防蓄意内鬼类延期到发布时点、编码前提实质清空——#1 核心 (a)(b) 已做、剩余全在延期桶内,阶段3/④ 改为发布时点执行序;详见 [[review-convergence-tcb-line-not-zero-findings]] "再澄清"+"三澄清"段、[[deliberate-insider-hardening-deferred-to-release]])。#5-F part3 的 soundness 虽有 V99 floor 兜底(C interim),但 #1 最小 TCB 闭包本身是收口前提。
