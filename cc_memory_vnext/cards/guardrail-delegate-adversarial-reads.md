...
== 判据 ==
一段内容若"很长 + 满是绕过/篡改/exec 字样",默认进子代理,不进主上下文。写审计提示词的受众纪律见 [[review-prompt-audience-purity]];外审剪贴板 staging 规程见 [[relay-review-clipboard-staging]]。
