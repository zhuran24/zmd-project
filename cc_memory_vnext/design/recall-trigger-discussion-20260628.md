...
>
> **⚠️ Superseded note(2026-06-28):本文件是 ③ 的【前置讨论档案】。③ 当前 canonical framing 已被 owner 喂 ChatGPT 后的 reframe 取代——见 `observable-commitment-gate-20260628.md`(可观测提交点记忆闸 / ZMEM_PROOF):③ 真问题是"逼模型在提交点真去查"(带门 pull),不是本文末尾收束的"愿不愿意为每回合看守付费"(那已降为【第四档】可选补强)。本文的四层方案(UPS 富化/L0 常驻/PreToolUse 窄门/影子)仍有效,但要重新挂到 gate 的"可观测性契约 + 提交点 proof"地基上读。**
