...
- `precompact-seqworker-auto-flow-a` — 2026-06-27:precompact skill 接 SeqWorker(A)=一条 -SendSeqB64 串行排[记忆更新回合,/compact],/compact 由串行结构保证落在记忆回合后(铁律机制化,记忆回合不再手动注/compact)…
