...
- `v-next` — MVP-0 完整落地(2026-06-27):cc_memory_vnext/ 合并 main e6d4a49+push;15卡/25金标准/eval25-25/三硬类StrictHitRate=100%纯脚本基线;2 hook 接进 settings.local.json 实测端到端命中=上线…
