...
- `clipboard-relay-deliverables-to-owner` — owner 2026-06-20 偏好 + 2026-06-21 + 2026-06-23 三次纠。产出需要 owner 手动 relay 的交付物(典型=给 GPT Pro 网页端的「快照包 + 任务书提示词」组合)时,直接把内容塞进 owner 的剪贴板…
...
- `p1-2-pyc-exec-digest-landed-88b2d32` — PYC-EXEC-DIGEST(round-3 外审 BLOCK)已闭,提交 88b2d32。**FIX-4 + 这个闭合后,所有已知 LIVE BLOCK 修完 = 收敛点达成**(详 roadmap 收敛标尺 + PROJECT_LOCK §soundness PYC…
